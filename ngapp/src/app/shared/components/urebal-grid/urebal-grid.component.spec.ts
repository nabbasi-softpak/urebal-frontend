...
import { UrebalGridComponent } from './urebal-grid.component';
...
xdescribe('UrebalGridComponent', () => {
  ...
  it('should create the urebal grid', inject([URebalService, UrebalPermissions],(urebalService, urebalPermissions: UrebalPermissions) => {
